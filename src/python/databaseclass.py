...
class DatabaseConnector:
    ...
    """
        ...
        @return
            ...
            - returns false otherwise
    """
    def messages_edit(self, userid, messageid, new_message):
        query = "UPDATE MESSAGES SET message = %s WHERE userid = %s AND messageid = %s"
        values = (new_message, userid, messageid)
        try:
